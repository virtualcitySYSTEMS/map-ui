...
The checkbox has always the size of its parent.
If you want to define a specific size use the `width` property:

```
<VcsCheckbox width="100" />
```

Note: The size of the checkbox has impact on the tooltip position.
</docs>
