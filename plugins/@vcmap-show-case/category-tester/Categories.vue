      ...
      <v-card class="pa-2">
        <v-form @submit.prevent="add">
          <v-select
            ...
            :items="['Category', 'AppBackedCategory']"
          />
          <v-select
                      ...
                      features: [
                        {
                          ...
                          geometry: {
                            ...
                            coordinates: [
                              [
                                [
                                  13.376044753386196, 52.51700747314845,
                                  34.434221826595746,
                                ],
                                [
                                  13.375890137534464, 52.51683412207231,
                                  34.43535288837092,
                                ],
                                [
                                  13.376141126603242, 52.51641627693124,
                                  34.66410424636929,
                                ],
                                [
                                  13.376773170085109, 52.516279904694215,
                                  34.73478984011562,
                                ],
                                [
                                  13.376887028670879, 52.51695485856382,
                                  34.72412287410914,
                                ],
                                [
                                  13.376044753386196, 52.51700747314845,
