...
<script lang="ts">
   ...
   * @vue-prop {ToolboxComponent<ToolboxType.SELECT>} group - A toolbox group of type 'select'.
   */
  export default defineComponent({
    ...
    props: {
      group: {
        type: Object as PropType<ToolboxComponent<ToolboxType.SELECT>>,
        required: true,
      },
    },
    emits: ['click', 'toggle'],
