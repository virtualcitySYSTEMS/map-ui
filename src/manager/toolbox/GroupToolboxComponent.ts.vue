...
<script lang="ts">
  ...
  import type { ToolboxComponent, ToolboxType } from './toolboxManager.js';
   ...
   * @vue-prop {ToolboxComponent<ToolboxType.GROUP>} group - A toolbox group of type 'group'.
  ...
  export default defineComponent({
    ...
    props: {
      group: {
        type: Object as PropType<ToolboxComponent<ToolboxType.GROUP>>,
        required: true,
      },
    },
    emits: ['click', 'toggle'],
    setup(props) {
      ...
      const buttons = computed(() => {
        ...
        return buttonManager.componentIds
          .map((id) => buttonManager.get(id))
