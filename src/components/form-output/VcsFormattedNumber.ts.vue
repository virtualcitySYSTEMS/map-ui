...
<script lang="ts">
   ...
   * @param locale can be used to set the locale, navigator.language is the default.
   * @paramoptions can be used to provide options to the function
   */
   ...
   * @property SQM square meters
   * @property CBM cubic meters
   * @property DEG degrees
   * @module VcsFormattedNumber
   */
  export enum SpecialUnits {
    SQM = 'sqm',
    CBM = 'cbm',
    DEG = 'deg',
  }
