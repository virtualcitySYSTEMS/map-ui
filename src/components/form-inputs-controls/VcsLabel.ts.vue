...
<script lang="ts">
  ...
  import VcsHelpTooltip from '../notification/VcsHelpTooltip.ts.vue';
   ...
   * @vue-prop htmlFor - an id reference the label is meant for.
   * @vue-prop [required=false] - Marks an input field as required by adding an asterisk after the label.
   * @vue-prop [disabled=false] - Marks an input field as disabled by adding transparency to the label.
   * @vue-prop [tooltipPosition='right'] - Position of the tooltip.
   * @vue-prop tooltip - Optional tooltip which will be shown on hover when no error message is shown
   */
