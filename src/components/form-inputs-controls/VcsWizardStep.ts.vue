...
<script lang="ts">
  ...
  import VcsHelp from '../notification/VcsHelp.ts.vue';
   ...
   * @vue-prop {Array<() => boolean>} [rules] - Vuetify rules.
  ...
  export default defineComponent({
    ...
    setup(props, { slots, emit }) {
      ...
      const helpAction = reactive<VcsAction>({
        name: 'help',
      ...
      const actions = computed<VcsAction[]>(() => {
