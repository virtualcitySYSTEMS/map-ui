<script setup lang="ts">
  ...
  const { actions, destroy } = createFlightPlayerActions(app, flightInstance);
  ...
  onMounted(async () => {
    flightInstancePlayer = await app.flights.setPlayerForFlight(flightInstance);
  ...
  const clockTime = (seconds: number): string => {
