        ...
        <v-row no-gutters v-if="!hideTitle">
          ...
          <v-col>
            <VcsTextField
              :id="`${cid}-title`"
              clearable
              :placeholder="$st('components.flight.titlePlaceholder')"
              v-model="title"
            />
          </v-col>
        </v-row>
        <v-row no-gutters v-if="!hideInterpolation">
          <v-col cols="6">
            <VcsLabel :html-for="`${cid}-interpolation`">
              {{ $st('components.flight.interpolation') }}
            </VcsLabel>
          </v-col>
          <v-col>
            <VcsSelect
